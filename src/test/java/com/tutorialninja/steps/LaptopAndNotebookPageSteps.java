...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new CheckoutPage().enterFirstName("Mehek");
        new CheckoutPage().enterLastName("Thakur");
        new CheckoutPage().enterEmailId("mehek");
        new CheckoutPage().enterTelephone("07777777000");
        new CheckoutPage().enterAddressLine1("10 keats court");
        new CheckoutPage().enterCity("London");
        new CheckoutPage().enterPostCode("HA0 3NZ");
